...
# Fuzzy Join auf den bereinigten Spalten durchführen
df_rq2_ <- stringdist_join(df_rq2, lo_categorization,
                          by = c("learn_descr" = "learning_outcome"),
                          mode = "left",
                          method = "jw", # Jaro-Winkler für "fast identische" Strings
                          max_dist = 0.01) # Max. Distanz-Wert anpassen für gute Ergebnisse

```

```{r adding additional codes manually, include=FALSE, eval=FALSE}
# df_rq2_ <- df_rq2_ %>%
