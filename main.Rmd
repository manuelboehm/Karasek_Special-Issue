...
pacman::p_load(papaja, knitr, dplyr, remotes, lme4, tidyr, kableExtra,
               ...
               sjPlot, devtools, rmdwc, fastDummies, crosstable, fuzzyjoin, datawizard) 
...
```{r, rq1 kable table, echo=FALSE, warning=FALSE}
...
```{r rq2 prepare the data, include=FALSE}
# table_rq2b 
# 29 tables: a table for all activity depicting all categories
